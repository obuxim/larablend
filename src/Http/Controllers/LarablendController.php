...
use Duoneos\Larablend\Models\ViewSetting;
...
class LarablendController extends Controller
{
    ...
    public static function index($model, $api, $model_path){
        ...
        if(class_exists($model_path)){
            ...
            if($api){
                ...
                return response()->view("larablend::index", ['data' => $all_entries, 'model' => $model, 'props' => $props]);
            }
        }else{
    ...
    public static function show($model, $id, $api, $model_path){
        ...
        try{
            ...
            if($api){
                ...
                return response()->view('larablend::show', ['toShow' => $toShow]);
            }
        }catch(\Exception $e){
            if($api){
                $error = new \stdClass();
    ...
    public static function create($model, $model_path){
        ...
        $data->fields = $fields;
        return response()->view('larablend::create', ['data' => $data, 'model' => str_replace('_', ' ', $model)]);
    }
    ...
    public static function edit($model, $id, $model_path){
        ...
        $data->fields = $fields;
        return response()->view('larablend::edit', ['data' => $data, 'model' => str_replace('_', ' ', $model), 'entry' => $entry]);
    }
